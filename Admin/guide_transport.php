...
$sql = "SELECT t.tour_id ,(t.capacity - t.available_seat) as booked_seat
        FROM guide g 
        INNER JOIN  tour t
...
<head>
    <meta charset="UTF-8">
    <title>Guide Control Transport</title>
...
<main class="main main__table-container">
    <h1 class="center">Guide Control Transport</h1>
    <table class="main__table transportation">
        <thead>
        <tr>
            <th id="tour-id" scope="col" class="table__head">Tour Id</th>
            <th id="hotel" scope="col" class="table__head">Transport</th>
        </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="table__item">
                    ...
                    $transportsSql =mysqli_query($conn,"SELECT from_place , to_place , type ,trn.start_date ,trn.start_time
                                                                ...
                                                                where g.username = '{$guide_username}' and t.tour_id = '{$tour['tour_id']}'");
