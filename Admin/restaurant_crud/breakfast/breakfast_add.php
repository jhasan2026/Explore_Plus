...
$error = array('breakfast' =>'', 'breakfast_cost' =>'');
...
<main class="main__crud">
    <h1 class="center"></h1>
    <form class="crud__all" action="breakfast_add.php" method="get">
        <h3 class="crud__h3">Breakfast Add Item:</h3>
        <fieldset class="crud__fieldset">
            ...
            <p class="crud__p">
                ...
                <input class="crud__input" type="text" name="breakfast_cost" id="breakfast_cost"  required autofocus>
            </p>
            <div class="crud__div">
